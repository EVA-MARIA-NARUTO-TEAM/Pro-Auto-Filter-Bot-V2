                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/developed_team_naruto"
                                )
                        ]
                    ]
                )
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('👤 Shanid 👤', url='https://t.me/HAZARD_77'),
        InlineKeyboardButton('+1 (620) 741-7649👤', url='https://t.me/CALL_ME_NARUTO_TEAM')
    ],[
        InlineKeyboardButton('👤 Naruto 👤', url='https://t.me/TEAM_NARUTO_GRUOP')
    ],[
